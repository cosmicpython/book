...
=== Moving domain layer tests to the service layer
...
.Moving domain tests to service layer (test_services.py)
====
[source,python]
[role="skip"]
----
...
// TODO: bit on when you would actually rewrite low-level tests.
