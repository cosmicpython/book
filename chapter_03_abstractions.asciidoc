...
What could we do to rewrite our code to make it more testable?((("abstractions", "choosing right abstraction", id="ix_abscho")))
...
That's all very well, but how do we _actually_ write those new((("abstractions", "choosing right abstraction", startref="ix_abscho")))
