...
Let's see an example.((("abstractions", "abstracting state to aid testability", id="ix_absstate"))) Imagine we want to write code for synchronizing two
...
going to stay slow, and hard to read and write.((("abstractions", "abstracting state to aid testability", startref="ix_absstate")))
