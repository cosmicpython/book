...
enumerating tests for all the edge cases is now much easier.((("testing", "after implementing chosen abstraction", "edge-to-edge testing with fakes and dependency injection", startref="ix_tstaftabsedge")))((("edge-to-edge testing", startref="ix_edgetst")))
