...
structure of our application.((("events and the message bus", "transforming our app into message processor", id="ix_evntMBMP"))) We'll move from the current state in
...
extended periods of time, managing a real-world process. ((("situated software")))Examples include
