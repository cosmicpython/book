...
// (EJ2) IMO "Smart Edges, Dumb Pipes" is a useful another useful idiom to keep validation straight.
// "Validation at the Edge" might be mis-interpreted as the "validate everything you can as soon as
//  you can."
