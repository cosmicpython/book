...
* We'll start to rebuild our application as a message-processor.
...
// TODO (DS): Are you really 'stretching a metaphor'?
...
// TODO (DS): I wonder if this para could be improved upon?
...
// TODO (DS): A sidebar explaining redis pubsub channels would be useful.
...
// TODO (DS): I'm generally a bit lost with this code snippet. Quite a lot of
// code to digest... Might a diff of the new code be a better way to present?

// TODO (DS): Where does subscribe_to_allocated_events come from?

// TODO (DS): Why the print statements?

// TODO (DS): What's the wait_for function?
...
// TODO (DS): I was confused by the flush argument
...
// TODO: This should be covered by a context or component diagram to show how
...
// TODO (DS): Maybe splitting this into Arrange-Act-Assert blocks would help
// readability.

// TODO (DS): Why staticmethod?

// TODO (DS): I think order1 etc would be clearer than o1
