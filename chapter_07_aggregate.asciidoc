...
concurrency bugs.  Consider using semaphores or similar concurrency primitives
...
Postgres documentation] (or whichever database you use--annoyingly, they all have quite radically different definitions.  Oracle's SERIALIZABLE is equivalent to Postgres's REPETABLE READ, for example.
