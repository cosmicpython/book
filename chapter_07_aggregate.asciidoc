...
pass:[<span class="keep-together">delighted</span>] by that. Business users _like_ spreadsheets because they're simple,
...
TIP: Transaction isolation levels are tricky stuff, so it's worth spending time
    ...
    pass:[<span class="keep-together">example</span>].]
