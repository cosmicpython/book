...
over time.((("domain driven design (DDD)", "choosing the right aggregate, references on")))((("Effective Aggregate Design (Vernon)"))) You can read more about it in multiple DDD books.
