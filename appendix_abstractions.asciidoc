...
[[three_parts]]
.Split our code into three  (sunc.py)
====
[source,python]
----
...
Choosing the right abstraction is very much an art. 

* What's the simplest data structure I can use to represent these dependencies?
...
TODO: can we do a better wrap-up?
