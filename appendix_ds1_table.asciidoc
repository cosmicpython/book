...
image::images/apwp_aa01.png["diagram showing all components: flask+eventconsumer, service layer, adapters, domain etc", width=731, height=597, scaledwidth=50%, scaledheight=50%]
