...
[[fake_messagebus]]
.Fake MessageBus implemented in UoW (tests/test_handlers.py)
====
[source,python]
[role="non-head"]
----
...
.Testing reallocation in isolation (tests/test_handlers.py)
====
[source,python]
[role="non-head"]
----
...
// TODO: this whole section would just be much nicer if we had an
// AbstractMessageBus and messagebus was a class. Come on Harry, bite the bullet.
