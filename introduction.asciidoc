...
// TODO (loosely based on SG feedback) there's a chance we're being a bit
// patronising here.  Can we reword this a bit along the lines of "as programmers
// we all recognise and try do this sort of thing at an intuitive level.  You
// may never have heard it described in these words but..."
// idk.  maybe even worse.
