...
[SG] what about a code example of using an ABC versus duck typing to flesh out what you
mean here?
...
////
[SG]  I was a bit suprised to see such an in depth explanation of "encapsulation"
 with detailed code examples in this Introduction: Why Do Our Designs Go Wrong. The other
 two sections on DIP and layering are much bigger topics but have more of an overview flavour.
////