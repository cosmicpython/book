...
In our tests we've implicitly defined an interface for what a UoW needs to do. Let's make that explicit by using an ((("Unit of Work pattern", "and its context manager")))((("context manager", "abstract UoW context manager")))abstract
base class:
