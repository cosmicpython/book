...
to get a custom messagebus.  Here's an example in an integration test:
...
Let's work through an example of how you might build an adapter, and do
dependency injection for it, "properly".
...
==== Figure out how to Integration Test :he Real Thing
