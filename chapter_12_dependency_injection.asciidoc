...
UoW around.  What about all these other things?

Since we've now made the messagebus into the core of our application, it's the
ideal place to manage these dependencies.

// TODO (DS): at this point i don't get what problem you're trying to solve.
// Haven't you already implemented dependency injection?
