...
and we'll do a bit of "Pure DI" (dependency injection without a framework).
...
=== Preparing Handlers: Pure DI with Partial Functions
...
.An Even-Purer DI, With Even Less Magic.
*******************************************************************************
