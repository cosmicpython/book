...
NOTE: Responsibility-driven design would describe the unit of work and the
repository as _collaborators_. Clusters of objects that _collaborate_ in their
roles are described as _object neighborhoods_ which is, in our professional
opinion, totally adorable.
