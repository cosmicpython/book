...
<1> The domain include your core model classes, as well as events and comments.  You might
    also include some domain-layer exceptions in here

<2> Adapters has our abstractions that let us interface with permanent storage and other.
