...
message broker (e.g., Kafka, EventStore). ((("Outbox pattern")))You might also look at the
...
A couple more books we'd like to((("resources, additional required reading"))) recommend to help you on your way:
