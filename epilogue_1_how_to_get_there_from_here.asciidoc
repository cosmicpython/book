...
Is it a smell for a use case to use multiple repositories/aggregates, and why?::
    ...
    https://oreil.ly/uZ4yt[these papers on aggregate design]
    by Vaughn Vernon.
 ...
 * https://oreil.ly/pcstD["You Cannot Have Exactly-once Delivery"]
 * https://oreil.ly/j8bmF["What You Want Is What You Don’t: Understanding Trade-Offs in Distributed Messaging"]
...
* https://oreil.ly/yERzR["How to Ensure Idempotency in an Eventual Consistent DDD/CQRS Application"]
* https://oreil.ly/Ekuhi["(Un) Reliability in messaging"]
