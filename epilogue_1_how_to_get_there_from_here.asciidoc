...
TIP: Aggregates are a _consistency boundary_. In general each use-case should
    ...
    result. If you need data from another part of the system, it's totally find
...
Practically this was a several month project. Our first step was to write a
...
infrasructural pieces. Our first production deployment was a tiny system, that
...
model, we were off. A couple of months later we were in production and serving
real customers.
...
play. Event Modelling is another technique that brings engineers and product
...
guides to visual modelling of systems with events.
...
// TODO: How can I convince other engineers to try this stuff?::
...
message broker (eg. Kafka, EventStore). You might also look at the 
...
* Greg Young wrote an entire book on
  https://www.goodreads.com/book/show/34327067-versioning-in-an-event-sourced-system[managing event-driven systems over time]:
...
Phew! That's a lot of warnings, and we hope we haven't scared you off completely.
Our goal with this book has been to give you just enough knowledge and intuition
that you can start building some of this for yourself. We would love to hear how
you get on and what problems you're facing with the techniques in your own
systems, so why not get in touch with us over at www.cosmicpython.com ?
