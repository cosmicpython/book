...
[SG] Maybe worth pointing out that you are implementing the simplest solution to pass this first test -
 ...
 first read this I initially thought the lack of check for sku was a mistake.
...
[SG] I would want to know if I tried to allocate to a batch and I was not able to.
Was it because I targeted the wrong batch for my sku?  Was it because the batch
was exhausted?
...
for goodness sake you are just looking in the wrong batch.
...
[SG] Why is Factory a code smell?
