...
// (EJ2) Agree with the above points, and would hope that readers are aware.
//       At a minimum I think you should point out the if your override
//       __hash__, you should also override __eq__; then wave your hands in the air,
//      warn that there are some important details, and leave a breadcrumb to 
