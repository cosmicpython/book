...
// Collaboration diagram goes here?
...
////
TODO (EJ)
. Maybe describe how MADE operates from the viewpoint of other stakeholders
(e.g., a customer ordering furniture, an accountant tracking credits and
debits, a customer service representative, or the warehouse that actually has
to store the stock) before diving into the Stock Allocation Service.  It will
help home the value of DDD and domain modeling.
////
...
////
TODO (EJ):   I find myself using collboration diagrams most frequently for
these kinds of things. A sequence diagram here would be good too, but they are
a little bit cumbersome to draw.  More
https://www.codemag.com/Article/0205051/UML-Collaboration-Diagrams[info]. ]
////
...
TODO: # e.j. Small style suggestion:
...
// TODO (EJ) I usually prefer to use the "key" parameter to sorted for things
// like this.  Then it's easier to implement more complex and arbitrary
// behaviors like "earliest, then smallest batch preferred".
