...
how we would construct a model from this business conversation.((("domain modeling", "unit testing domain models", id="ix_dommodUT")))
...
One of the nice things that dataclasses (or named tuples) give us is _value
...
defines the behavior of the class for the `==` operator.footnote:[The +++<code>__eq__</code>+++ method is pronounced "dunder-EQ." By some, at least.]
...
WARNING: This is tricky territory; you shouldn't modify +++<code>__hash__</code>+++ without
    ...
    "Python Hashes and Equality"] by our tech reviewer Hynek Schlawack is a good place to start.((("domain modeling", "unit testing domain models", startref="ix_dommodUT")))
