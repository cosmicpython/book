...
TODO: discuss what a domain service is.
...
And our service looks like this:
...
Python's magic methods allow us to use that nice, idiomatic `sorted()` function;
...
If you really want to go to town with type hints
...
<1> You can even use "NewType" here to wrap primitive values. This allows our type
