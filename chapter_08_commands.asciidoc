...
//TODO: need to tweak the language here, because we're using events to represent
// API calls, eg AllocationRequested
// Why is the API wrong to call those things events?
