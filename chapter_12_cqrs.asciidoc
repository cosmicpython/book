...
[.keep-together]#nervous# at first, so let's talk quickly about that.((("consistency", "attainment of read consistency")))((("command-query responsibility segregation (CQRS)", "reads", "consistency of")))
