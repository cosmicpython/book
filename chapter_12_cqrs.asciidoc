...
https://github.com/cosmicpython/code/tree/chapter_12_cqrs[chapter_12_cqrs] branch.
...
joins. The fastest queries will always be `SELECT * from _mytable_ WHERE _key_ =
:__value__`
...
you to your database. We'd like to show you how we can reuse our event-driven
...
=== Wrap-Up: But Would You Really?  CRUD versus CQRS.
