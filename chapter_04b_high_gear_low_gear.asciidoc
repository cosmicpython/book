...
and at which level.  They changed my testing-life._
*******************************************************************************
...
* Add any additional services you need to be able to test entirely against the
  service layer, rather than hacking state in via repositories or the DB. This
  will pay off in your end-to-end tests as well.
