...
=== Testing Edge-to-Edge with Service Layer, and High Gear vs Low Gear
...
.Harry Says: Seeing a Test Pyramid in Action Made me a Convert
*******************************************************************************
I was initially skeptical of all Bob's architectural patterns, but seeing
an actual Test Pyramid made me a convert.

Once you implement domain modelling and service layer, you really actually can
...
difference it makes to be able to run all your tests in minutes or seconds.

Read on for some guidelines on how to decide what kinds of tests to write,
and at which level.  They changed my testing-life.
*******************************************************************************
