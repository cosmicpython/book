...
an integration test versus a unit test.((("Flask framework", "Flask API and service layer", "first API end-to-end test", id="ix_Flskappe2e")))((("testing", "end-to-end test of allocate API", "first draft")))((("end-to-end tests", "of allocate API")))((("APIs", "end-to-end test of allocate API"))) Different projects need different
...
But hang on a minute--there's no commit.((("databases", "testing allocations persisted to database")))((("testing", "end-to-end test of allocate API", "testing allocations are persisted"))) We're not actually saving our
...
we even invoke the domain service.((("testing", "end-to-end test of allocate API", "testing error cases")))
...
the happy path and one((("testing", "end-to-end test of allocate API", "testing happy and unhappy paths")))((("service layer", "end-to-end test of allocate API", "testing happy and unhappy paths")))((("Flask framework", "Flask API and service layer", "end-to-end tests for happy and unhappy paths"))) for the unhappy path:
