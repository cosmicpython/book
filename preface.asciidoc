...
http://www.obeythetestinggoat.com/pages/book.html[_Test-Driven Development with Python_] (O'Reilly),
...
a replacement for the classics in the field like Eric Evans's
...
How do i get there from here? (<<epilogue_1_how_to_get_there_from_here>>)::
    ...
    few pointers in this epilogue and some links to further reading.
