...
////
TODO (EJ)
I agree on the service layer box, as I'm not sure that it adds much here, and the focus is on UoW.

About the sequence diagram, there are a couple things that might help:
