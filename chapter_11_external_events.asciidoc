...
((("Distributed Ball of Mud anti-pattern", "and thinking in nouns", id="ix_DBoM")))
...
((("Distributed Ball of Mud anti-pattern", "and thinking in nouns", startref="ix_DBoM")))
...
((("Distributed Ball of Mud anti-pattern", "avoiding")))
