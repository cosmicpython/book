...
https://github.com/cosmicpython/code/tree/chapter_11_external_events[chapter_11_external_events] branch.
...
async one, you also open up a whole host of problems to do with message
reliability and eventual consistency.   Read on to the <<footguns>> section in
the epilogue.
