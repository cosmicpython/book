...
"Things break" is a universal law of software engineering.((("error handling", "in distributed systems", id="ix_errhnddst"))) What happens in our
...
How do we get ((("error handling", "in distributed systems", startref="ix_errhnddst")))appropriate coupling? We've already seen part of the answer, which is that we should think in
