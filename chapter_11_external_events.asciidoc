...
Before we get into that, let's talk about the alternatives.((("Ball of Mud pattern", "distributed ball of mud and thinking in nouns")))((("microservices", "event-based integration", "distributed Ball of Mud and thinking in nouns", id="ix_mcroevntBoM"))) We regularly talk to
...
split their system into _nouns_.((("nouns, splitting system into")))
...
how services quickly get tangled up.((("microservices", "event-based integration", "distributed Ball of Mud and thinking in nouns", startref="ix_mcroevntBoM")))
