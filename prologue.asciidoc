...
the better term here. Here's source http://www.wirfs-brock.com/Design.html[info on where "roles and responsibilities"]]
...
So some of the language here reads a bit funny to me.]
