...
// IDEA (hynek) Dunno if you wanna go there but we've got TypedDict in 3.8 now
...
https://github.com/cosmicpython/code/tree/chapter_07_events_and_message_bus_exercise
