...
NOTE: Responsibility-Driven Design has a whole taxonomy of object roles and
talks about object _stereotypes_. A stereotype describes the kind of role that
an object plays in a system. Our use-case functions are _co-ordinators_ and
our flask endpoint is an _interfacer_. Notice that "handles http requests" and
"runs the allocation process" are _responsibilities_. Can you identify the
collaborators of our use-cases?
...
////
TODO:
should we go into full detail?
"1. High-level modules should not depend on low-level modules. Both should depend on abstractions"
"2. Abstractions should not depend upon details. Details should depend upon abstractions"

EJ COMMENT:
I would go ahead into full detail here.  It's a very straightforward example of
"details depending on abstractions."  The other way to motivate this is by
posing hypothetical scenarios, like using the local filesystem for testing, or
switching to MongoDB instead of SQL.
////
