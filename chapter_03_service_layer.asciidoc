...
This is what people mean when they say "depend on abstractions". footnote:[e.j. I would
go ahead into full detail here.  It's a very straightforward example of "details depending
on abstractions."  The other way to motivate this is by posing hypothetical scenarios, like
using the local filesystem for testing, or switching to MongoDB instead of SQL.]
...
update tens or even hundreds of unit tests.  footnote:[e.j. I think
this is one of those things that borders on a war of religion.  Might want to have
some sidebar on BDD, and the perils of test coverage metrics.]
...
implementation. footnote:[e.j. an example that is overmocked would be good here
