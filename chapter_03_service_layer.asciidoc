...
Sidebar on fakes, stubs, spies?
Sidebar on London vs Chicago testing?

Good inspiration here: https://softwareengineering.stackexchange.com/questions/123627/what-are-the-london-and-chicago-schools-of-tdd
More feedback on this in https://github.com/python-leap/book/issues/43
...
I think this actually makes a lot of sense. IT helps us to demonstrate that our choice of architectural patterns allows us to decouple the operations of our system from the interface we present to the outside world. -- bob
