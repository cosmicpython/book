...
MessageBus -> UoW : start unit of work
MessageBus -> Domain : allocate()
Domain -> UoW: raise Allocated events(s)
MessageBus -> UoW: commit
UoW -> DB: update write model
UoW -> MessageBus : publish Allocated event(s)
