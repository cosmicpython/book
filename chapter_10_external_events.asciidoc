...
I'm having a little bit of trouble understanding the sequence diagrams because
I'm unsure what the arrow semantics are. The couple things I've noticed are:
