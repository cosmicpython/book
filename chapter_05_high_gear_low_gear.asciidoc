...
our service-layer functions.((("service layer", "fully decoupling from the domain", id="ix_serlaydec")))
...
we see fit.((("service layer", "fully decoupling from the domain", startref="ix_serlaydec")))
