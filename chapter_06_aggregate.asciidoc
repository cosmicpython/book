...
(HP) - as in, canonical model is an antipattern?

naively: https://www.enterpriseintegrationpatterns.com/patterns/messaging/CanonicalDataModel.html
but: https://martinfowler.com/bliki/MultipleCanonicalModels.html
and: https://medium.com/@teivah/why-is-a-canonical-data-model-an-anti-pattern-441b5c4cbff8 

so you're saying, point people to the argument that says "don't try and build a single canonical model?"
////
