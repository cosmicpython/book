...
// TODO (hynek) no you don't (discuss the concept of a consistency boundary),
// that term doesn't come up until chapter 9
// (EJ1) I think you can limbo your way out of this by saying 
//          "an aggregate as a unit of consistency" instead of "consistency boundary."
...
// TODO (hynek) at no point have you explained what an aggregate is
// (EJ1) I think you can also limbo your way out of this by saying "discuss how the Aggregate"
//       concept is useful for" instead of "discuss choosing an aggregate"
...
// TODO (hynek) this isn't greate.  there really should be a seciton "what is an
// aggregate before starting "choosing the right aggregate" and basically explaining
// it using only an evans quote
// (EJ2) Agree with above, but OTOH, explaining Aggregate is notoriously difficult,
//       and often just boils down to seeing a lot of examples.
//
//       What would be really nice here is if you had an example of a badly chosen
//       aggregate that create headaches.  I'm not sure if Warehouse or Shipment
//       would be obviously bad without a lot of explanation.
...
// TODO (hynek) pls make up your mind on capitalisation
...
// TODO (hynek) (re # type: List[Exception]) why don't you use the proper syntax
// for variable type annotations
// (HP) because its hella ugly.
