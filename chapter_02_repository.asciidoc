...
NOTE: The repository is an excellent example of an object with a named
_reponsibility_: it holds objects in persistent state and lets us get access to
them. _Repository_ is a _role_ in our system, and we can plug different objects
into that role.
