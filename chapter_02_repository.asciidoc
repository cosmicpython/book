...
As mentioned in the pass:[<a data-type="xref" href="introduction">introduction</a>], a layered architecture is ((("data access", "applying dependency inversion principle to")))((("layered architecture")))a common
