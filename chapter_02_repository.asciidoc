...
https://github.com/python-leap/book/issues/42


-----

Maybe we do this just before we do the SQL Alchemy mapping? I think people find
it helpful to have a map of where they're going, rather than a map of where
they've just been.
////
...
////
TODO:
Someone in the audience of my mocking talk at PyCon asked if doing dependency injection would require defining and deriving IWhatever interfaces everywhere. My answer was that in Python you can rely on duck-typing. (I am unsure how well this plays out with type annotations). It may be worth calling out explicitly what you would do instead of ABCs.
