...
The _Repository pattern_ is an abstraction over persistent storage.((("domain model", startref="ix_domod")))((("Repository pattern", id="ix_Repo"))) It hides the
...
they help explain what the interface of the repository abstraction is.((("abstract base classes (ABCs)", "duck typing and protocols")))
