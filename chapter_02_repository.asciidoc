...
At this point we'd like to encourage you to go and read
<<chapter_02B_abstractions>>, where we talk a bit more about how to choose
abstractions, and how they can help us to break up our code into manageable,
testable chunks.

TODO: move abstractions appendix into main body of book as a proper chapter

Now, how do we actually instantiate these repositories, fake or real?
