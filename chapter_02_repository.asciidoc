...
As mentioned in <<introduction>>, a layered architecture is ((("layered architecture")))a common
...
pretty much names for the same thing, and((("dependency inversion principle"))) they all boil down to the
