...
// [KP] Another possibility would be to use protocols as introduced in Python 3.8 (PEP 544).
...
////
[KP] I think, you make the same point later at chapter_02_repository_tradeoffs. It may
be worth repeating, though.
////
