...
a system to another.((("commands", "events versus", id="ix_cmdevnt"))) We usually represent commands with dumb data
...
Just changing ((("commands", "events versus", startref="ix_cmdevnt")))the names and verb tenses is all very well, but that won't
