...
Just changing ((("events", "commands versus", startref="ix_evntcmd")))((("commands", "events versus", startref="ix_cmdevnt")))the names and verb tenses is all very well, but that won't
