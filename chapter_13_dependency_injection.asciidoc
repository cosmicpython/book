...
or if ((("dependency chains")))((("dependency injection", "using DI framework")))you ever get into _dependency chains_ (where your dependencies have their
...
To really get a feel((("adapters", "building adapter and doing dependency injection for it", id="ix_adapDI")))((("adapters", "building adapter and doing dependency injection for it")))((("dependency injection", "doing for an adapter"))) for how it all works, let's work through an example of how
