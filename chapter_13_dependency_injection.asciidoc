...
framework,footnote:[Mark Seemann calls this https://blog.ploeh.dk/2012/11/06/WhentouseaDIContainer[_Pure DI_] or sometimes _Vanilla DI_.]):
...
And that's it really. In summary:
